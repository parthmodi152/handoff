...
//
//  NOTE: This file must be in the app target because LiveActivityIntent
//  runs perform() in the app's process. A copy also exists in the widget
//  extension target for compilation of the Live Activity UI.
//
